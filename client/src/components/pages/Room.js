    ...
    render() {
        ...
        return (
            <>
                ...
                <Music url = {this.state.song.youtubeUrl? this.state.song.instrumentalUrl: this.state.song.instrumentalUrl} visual={true} pauseButton={false} roomID = {this.props.roomID} />
        </Box>:<></>} 
